...
==============================
In this assignment, I'll do some practice at building effective unit tests. Using the example from Coursera course videos, I'll be developing tests for the Demo class, including the isTriangle() and main() methods.

My task is to create a file, DemoTest.java, which properly tests the Demo class to ensure it is working properly. The correct Demo.java file is collected from a coursera course which is offered by Univerity of Minnesota. This Readme file is also provided by them though I make some changes in this file according to my need.
